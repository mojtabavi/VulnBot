...
class CollectorPrompt:
    init_plan_prompt: str = """You are an Reconnaissance Assistant running on Kali Linux 2023. 
    ...
    init_reasoning_prompt: str = """You are an Reconnaissance Assistant running on Kali Linux 2023. 
    Your role is to assist testers in the cybersecurity training process.
